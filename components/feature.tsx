...
import Center from '@/public/images/c.png'
import Students from '@/public/images/stud.png'
            ...
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6 pt-20">
                <div className="pt-12 md:pt-20">
                    ...
                    <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
                        <h1 className="h2 mb-4">Сабира домбыра мектебі</h1>
                        <p className="text-xl text-gray-200">Домбыраның мәңгілік әуендері жанданатын ортаға қош келдіңіз!.</p>
                    </div>
                    ...
                    <div className="md:grid md:grid-cols-12 md:gap-6">
                        ...
                        <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
                            <div className="md:pr-4 lg:pr-12 xl:pr-16 mb-8">
                                <h3 className="h3 mb-3">Біздің мектеп туралы</h3>
                                <p className="text-xl text-gray-300">Біз әртістерді дамыту, құмарлықты ояту және қауымдастық құру үшін саяхатқа аттанардыратын музыкалық мәдени орта</p>
                            </div>
                            {/* Tabs buttons */}
                            <div className="mb-8 md:mb-0">
                                ...
                                >
                                    <div>
                                        ...
                                        <div className="text-black">Студенттерге домбыра музыкасының қызықты әлемін зерттеу үшін мұқият ортаны жасау</div>
                                    </div>
                                ...
                                >
                                    <div>
                                        ...
                                        <div className="text-black">Музыкалық білімді терең бағалауымыз өнерімізді дамыту үшін дәлел болды</div>
                                    </div>
                                    <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                                        <svg className="w-3 h-3 fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                                ...
                                >
                                    <div>
                                        ...
                                        <div className="text-black">5 жыл бойы мұраны сақтау және музыкалық сүйіспеншілікті арттыруда қойылымдамын</div>
                                    </div>
                                    <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                                        <svg className="w-3 h-3 fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="relative flex flex-col text-center lg:text-right" data-aos="zoom-y-out" ref={tabs}>
                                    ...
                                    >
                                        <div className="relative inline-flex flex-col">
                                            <Image className="md:max-w-none mx-auto rounded-2xl" src={Center} width={500} height="462" alt="Features bg" />
                                    ...
                                    >
                                        <div className="relative inline-flex flex-col">
                                            <Image className="md:max-w-none mx-auto rounded-2xl" src={Students} width={500} height="462" alt="Features bg" />
                                            {/*<Image className="md:max-w-none absolute w-full left-0 transform animate-float" src={FeaturesElement} width={500} height="44" alt="Element" style={{ top: '30%' }} />*/}
                                        </div>
                                    </Transition>
                                    {/* Item 3 */}
                                    ...
                                    >
                                        <div className="relative inline-flex flex-col">
                                            <Image className="md:max-w-none mx-auto rounded-2xl" src={Year} width={500} height="462" alt="Features bg" />
                                            {/*<Image className="md:max-w-none absolute w-full left-0 transform animate-float" src={FeaturesElement} width={500} height="44" alt="Element" style={{ top: '30%' }} />*/}
                                        </div>
                                    </Transition>
                                </div>
